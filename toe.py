...
@click.command()
@click.option("--width", type=int, help="The width of the map.")
@click.option("--height", type=int, help="The height of the map.")
...
@click.option("--ui-turn-delay", type=float, default=0.3, help="Seconds to wait between turns when showing the ui.")
